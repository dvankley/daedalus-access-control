...
namespace DaedalusTestApp
{
    ...
    {
        const string goodAESKey = "I<3Ponies";
        const string badAESKey = "sendinthedancinglobsters";
        ...
        public void BuildEncryptedPacketFromDecryptedPacketSuccess()
        {
            ...
            EncryptedDaedalusPacket encryptedPacket1 = new EncryptedDaedalusPacket(packet, goodAESKey);
            ...
            EncryptedDaedalusPacket encryptedPacket2 = new EncryptedDaedalusPacket(encryptedPacketBuffer, 0, encryptedPacketBuffer.Length, out returnCode, goodAESKey);
        ...
        public void BuildEncryptedPacketFromEncryptedBufferSuccess()
        {
            ...
            Assert.IsTrue(packetStart == 0);
            Assert.IsTrue(packetLength == testPacket.Length);
            EncryptedDaedalusPacket encryptedPacket2 = new EncryptedDaedalusPacket(testPacket, packetStart, packetLength, out returnCode, goodAESKey);
            Assert.IsNotNull(encryptedPacket2);
            byte[] decryptedPayload2 = encryptedPacket2.decryptedPayload;
            Assert.IsNotNull(decryptedPayload2);
        ...
        public void DecryptPacketFromBytesAESKeyFailure()
        {
            ...
            try
            {
                ...
                EncryptedDaedalusPacket encryptedPacket2 = new EncryptedDaedalusPacket(testPacket, packetStart, packetLength, out returnCode, badAESKey);
                Assert.IsNotNull(encryptedPacket2);
